...
const albumFallbacks: HomePageData['recentTools'] = [
  {
    ...
    name: '我的聚会相册',
    usedAt: '',
    imageUrl: '/assets/party-recorder/home-album-cover-host.webp',
    badgeText: '相册',
    badgeClass: '',
  ...
  },
  {
    ...
    name: '参与过的聚会',
    usedAt: '',
    imageUrl: '/assets/party-recorder/home-album-cover-joined.webp',
    badgeText: '参与',
    badgeClass: '',
  ...
  },
  {
    ...
    name: '分享图记录',
    usedAt: '',
    imageUrl: '/assets/party-recorder/home-album-cover-shares.webp',
    badgeText: '分享',
    badgeClass: '',
